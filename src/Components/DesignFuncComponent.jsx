...
function DesignFuncComponent() {
    ...
    const showDetails = () => { 
        ...
        document.getElementById('info').innerHTML = "I am pursuing B.Tech Information Technology"
    ...
    return (
        <React.Fragment>
            <div className="container">
                ...
                <div><h1>Name: Aishwarya T M</h1></div>
                <div><p>Registeration No: 212221220002</p></div>
                <div id="info"></div>
